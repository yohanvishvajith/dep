...
/**
    ...
    {
        $reservations = Reservation::with(['vehicle', 'vehicle.images', 'review'])
    ...
    {
        $reservation = Reservation::with(['vehicle', 'vehicle.images'])
            ->where('reservation_id', $id)
            ->where('user_id', auth()->id())
            ->firstOrFail();

        return view('reservation_details', compact('reservation'));
    }
    ...
    public function cancelReservation(Request $request, $id)
    {
        ...
        return redirect()->route('user.reservations')->with('success', 'Reservation cancelled successfully');
    }
}
